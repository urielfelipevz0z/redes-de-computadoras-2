...
% Colores para terminal Linux/Bash (tema oscuro)
\definecolor{linuxframe}{RGB}{60, 60, 60}
\definecolor{linuxbg}{RGB}{40, 40, 40}
\definecolor{linuxwhite}{RGB}{255, 255, 255}
\definecolor{linuxcyan}{RGB}{0, 255, 255}
\definecolor{linuxgreen}{RGB}{0, 255, 0}
\definecolor{linuxyellow}{RGB}{255, 255, 0}
\definecolor{linuxblue}{RGB}{100, 149, 237}
\definecolor{linuxgray}{RGB}{169, 169, 169}
...
\lstdefinestyle{custom-bash-style}{
  ...
  % Prompts de usuario
  moredelim=[s][\bfseries\color{linuxgreen}]{ccna@}{$},
  moredelim=[s][\bfseries\color{linuxgreen}]{root@}{$},
  moredelim=[s][\bfseries\color{linuxgreen}]{user@}{$},
  moredelim=[s][\bfseries\color{linuxgreen}]{ubuntu@}{$}
}
...
\newcommand{\forceloadstyles}{%
  ...
  \lstset{style=custom-bash-style}%
}