...
- MAC flooding con patrones específicos para evadir detección
- Timing attacks para evitar sistemas de monitoreo
- Combinación con otros tipos de ataques (ARP spoofing, VLAN hopping)
